...
public class Left extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory delConeFW2 = drive.trajectoryBuilder(delConeRS.end().plus(new Pose2d(0,0, Math.toRadians(-47))))
                .forward(-9,
        ...
        /*Trajectory delConeBW = drive.trajectoryBuilder(delConeFW2.end())
                ...
                .build();
*/
        Trajectory park1 = drive.trajectoryBuilder(delConeFW3.end().plus(new Pose2d(0,0, Math.toRadians(47))))
        ...
        Trajectory park3 = drive.trajectoryBuilder(delConeFW3.end().plus(new Pose2d(0,0, Math.toRadians(47))))
